            ...
            if chart_klines:
                ...
                for o in active_orders:
                    ...
                    if is_active_pos:
                        ...
                        series_list.append(
                            ftc.LineChartData(
                                points=[ftc.LineChartDataPoint(act_x_index, entry), ftc.LineChartDataPoint(max_chart_x, entry)],
                                stroke_width=1.5,
                                color="#38bdf8",
                                dash_pattern=[5, 5]
                            )
                        ...
                        if o.get("take_profit"):
                            ...
                            series_list.append(
                                ftc.LineChartData(
                                    points=[ftc.LineChartDataPoint(act_x_index, tp), ftc.LineChartDataPoint(max_chart_x, tp)],
                                    stroke_width=1,
                                    color="#10b981",
                                    dash_pattern=[3, 3]
                                )
                        ...
                        if o.get("stop_loss"):
                            ...
                            series_list.append(
                                ftc.LineChartData(
                                    points=[ftc.LineChartDataPoint(act_x_index, sl), ftc.LineChartDataPoint(max_chart_x, sl)],
                                    stroke_width=1,
                                    color="#ef4444",
                                    dash_pattern=[3, 3]
                                )
